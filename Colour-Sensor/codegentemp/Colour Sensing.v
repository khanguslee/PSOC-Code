// ======================================================================
// Colour Sensing.v generated from TopDesign.cysch
// 08/19/2017 at 21:32
...
// TIA_v2_0(Capacitive_Feedback=2, Fcorner=373 kHz, Power=3, Resistive_Feedback=4, vdda_value=5, CY_API_CALLBACK_HEADER_INCLUDE=#include "cyapicallbacks.h", CY_COMMENT=, CY_COMPONENT_NAME=TIA_v2_0, CY_CONST_CONFIG=true, CY_CONTROL_FILE=<:default:>, CY_DATASHEET_FILE=<:default:>, CY_FITTER_NAME=TIA_1, CY_INSTANCE_SHORT_NAME=TIA_1, CY_MAJOR_VERSION=2, CY_MINOR_VERSION=0, CY_PDL_DRIVER_NAME=, CY_PDL_DRIVER_REQ_VERSION=, CY_PDL_DRIVER_SUBGROUP=, CY_PDL_DRIVER_VARIANT=, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=PSoC Creator  4.1 Update 1, INSTANCE_NAME=TIA_1, )
module TIA_v2_0_0 (
    Iin,
    Vref,
    Vout);
...
module ADC_DelSig_v3_20_1 (
	...
	cy_clock_v1_0
		#(.id("8a395bd3-864a-405b-a86e-10c8bb0ad9af/b7604721-db56-4477-98c2-8fae77869066"),
	...
	cy_clock_v1_0
		#(.id("8a395bd3-864a-405b-a86e-10c8bb0ad9af/edd15f43-b66b-457b-be3a-5342345270c8"),
		  .source_clock_id("61737EF6-3B74-48f9-8B91-F7473A442AE7"),
		  .divisor(0),
...
module top ;
	...
	wire [0:0] tmpOE__PD_IN_net;
	wire [0:0] tmpFB_0__PD_IN_net;
	wire [0:0] tmpIO_0__PD_IN_net;
	wire [0:0] tmpINTERRUPT_0__PD_IN_net;
	electrical [0:0] tmpSIOVREF__PD_IN_net;
	...
	cy_psoc3_pins_v1_10
		...
		PD_IN
		 (.oe(tmpOE__PD_IN_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__PD_IN_net[0:0]}),
		  .analog({Net_6}),
		  .io({tmpIO_0__PD_IN_net[0:0]}),
		  .siovref(tmpSIOVREF__PD_IN_net),
		  .interrupt({tmpINTERRUPT_0__PD_IN_net[0:0]}),
		  .annotation({Net_30}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
	...
	assign tmpOE__PD_IN_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
	...
	cy_psoc3_pins_v1_10
		#(.id("0f7b5ab1-57bd-42a8-b2a0-944397c65a7a"),
		  .drive_mode(3'b010),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
