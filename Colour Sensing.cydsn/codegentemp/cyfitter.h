...
/* PD_IN */
#define PD_IN__0__INTTYPE CYREG_PICU0_INTTYPE7
#define PD_IN__0__MASK 0x80u
#define PD_IN__0__PC CYREG_PRT0_PC7
#define PD_IN__0__PORT 0u
#define PD_IN__0__SHIFT 7u
#define PD_IN__AG CYREG_PRT0_AG
#define PD_IN__AMUX CYREG_PRT0_AMUX
#define PD_IN__BIE CYREG_PRT0_BIE
#define PD_IN__BIT_MASK CYREG_PRT0_BIT_MASK
#define PD_IN__BYP CYREG_PRT0_BYP
#define PD_IN__CTL CYREG_PRT0_CTL
#define PD_IN__DM0 CYREG_PRT0_DM0
#define PD_IN__DM1 CYREG_PRT0_DM1
#define PD_IN__DM2 CYREG_PRT0_DM2
#define PD_IN__DR CYREG_PRT0_DR
#define PD_IN__INP_DIS CYREG_PRT0_INP_DIS
#define PD_IN__INTTYPE_BASE CYDEV_PICU_INTTYPE_PICU0_BASE
#define PD_IN__LCD_COM_SEG CYREG_PRT0_LCD_COM_SEG
#define PD_IN__LCD_EN CYREG_PRT0_LCD_EN
#define PD_IN__MASK 0x80u
#define PD_IN__PORT 0u
#define PD_IN__PRT CYREG_PRT0_PRT
#define PD_IN__PRTDSI__CAPS_SEL CYREG_PRT0_CAPS_SEL
#define PD_IN__PRTDSI__DBL_SYNC_IN CYREG_PRT0_DBL_SYNC_IN
#define PD_IN__PRTDSI__OE_SEL0 CYREG_PRT0_OE_SEL0
#define PD_IN__PRTDSI__OE_SEL1 CYREG_PRT0_OE_SEL1
#define PD_IN__PRTDSI__OUT_SEL0 CYREG_PRT0_OUT_SEL0
#define PD_IN__PRTDSI__OUT_SEL1 CYREG_PRT0_OUT_SEL1
#define PD_IN__PRTDSI__SYNC_OUT CYREG_PRT0_SYNC_OUT
#define PD_IN__PS CYREG_PRT0_PS
#define PD_IN__SHIFT 7u
#define PD_IN__SLW CYREG_PRT0_SLW
...
#define CY_PROJECT_NAME "Colour Sensing"
