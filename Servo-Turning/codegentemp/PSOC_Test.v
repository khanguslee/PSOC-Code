// ======================================================================
// PSOC_Test.v generated from TopDesign.cysch
// 08/12/2017 at 03:06
...
module top ;
    ...
    UART_v2_50_1 UART_1 (
        ...
        .reset(1'b0),
        .rx(Net_694),
        .tx_interrupt(Net_695),
        .rx_interrupt(Net_696),
        .tx_data(Net_697),
        .tx_clk(Net_698),
        .rx_data(Net_699),
        .rx_clk(Net_700));
	...
	cy_clock_v1_0
		#(.id("16546165-53ce-4aa2-a725-011ae33926d2"),
		  .source_clock_id(""),
		  .divisor(0),
		  .period("500000000"),
		  .is_direct(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("f4c601ba-b92d-4ed8-b14b-92d66a79c257"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
